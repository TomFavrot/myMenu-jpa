...
//		ajustement2.setQuantiteModifiee(4F);
//		ingredient1.setAjustementQuantite(ajustement1);
//		ingredient2.setAjustementQuantite(ajustement2);
//		
//		ajustement1 = ajustementRepo.save(ajustement1);
//		
//	    ajustement2 = ajustementRepo.save(ajustement2);
...
//		listeCourse2.setAjustementQuantite(ajustement2);
//		
//		listeCourse1 = listeCourseRepo.save(listeCourse1);
//		listeCourse2 = listeCourseRepo.save(listeCourse2);
//		
//		List<ListeCourse> courses = listeCourseRepo.findAll();
//	
//		Assert.assertEquals(ingredients.size(), courses.size());
//		
//				
//	ListeCourse listeFind = listeCourseRepo.findById(listeCourse1.getId());
//		AjustementQuantite ajFind = ajustementRepo.findById(ajustement1.getId());
